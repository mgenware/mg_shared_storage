...
First off, thanks for considering donating your time, we know how precious it should be, Shared Storage plugin will be always open to contribution to people like you who cares about the source you import in your project.

These guidelines are intended to provide you a brief explanation about our development process and how you can join us to improve even more.

Also, following this guidelines shows your effort in respect the time of the developers managing and developing this project and we'll return by addressing, labeling your issue, implementing new features and helping you with your pull request.
...
- Bug triaging
- Writing tutorials
- Sharing useful Android resources
- Requesting new Android and method APIs
- Implementing a new feature
- Reviewing PR or the source code
- \<Insert here your idea that can improve this plugin\>
...
- Ensure your code follow the [Dart lint package](http://pub.dev/packages/lint) and do not by-pass any rule
- Create issues for any major changes and enhancements that you wish to make. Discuss things transparently and get community feedback.
- Keep feature versions as small as possible, preferably one new feature per version.
- Be welcoming to newcomers and encourage diverse new contributors from all backgrounds. See the [Code of Conduct](https://github.com/lakscastro/shared-storage/blob/cc07a5d9a06392a2253a38e9dea67786718916bf/CODE_OF_CONDUCT.md).

# Your First Contribution

There's several ways to contribute as you saw previously,

First contribution is always the hard one. You can start by [setting up your local development.]()
